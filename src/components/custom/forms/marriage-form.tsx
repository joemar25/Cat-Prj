  ...
  return (
    <div className="container mx-auto p-4">
      <Card className="w-full max-w-4xl mx-auto">
        <CardHeader>
          <CardTitle className="text-2xl text-center">Marriage Certificate Request Form</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-6">
              <div className="border rounded-lg p-4 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="husbandName" placeholder="Enter husband's full name" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="marriagePlace" placeholder="Enter place of marriage" />
                </div>
