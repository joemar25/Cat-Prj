...
import {
  ...
  Place,
  SolemnizingOfficer,
} from '@/types/marriage-certificate';
...
const PreviewField: React.FC<{ label: string; value: PreviewValue }> = ({
  label,
  value,
}) => {
...
const MarriageCertificatePreview: React.FC<MarriageCertificatePreviewProps> = ({
  data,
}) => {
        ...
        <ScrollArea className='h-full'>
          <div className='space-y-6 pb-6'>
            ...
            <PreviewSection title="Husband's Family">
              <PreviewField
                label="Father's Name"
                value={formatName(data.husbandFatherName)}
              />
              <PreviewField
                label="Father's Citizenship"
                value={data.husbandFatherCitizenship}
              />
              <PreviewField
                label="Mother's Maiden Name"
                value={formatName(data.husbandMotherMaidenName)}
              />
              <PreviewField
                label="Mother's Citizenship"
                value={data.husbandMotherCitizenship}
              />
            </PreviewSection>
            ...
            <PreviewSection title="Wife's Information">
              ...
              <PreviewField
                label='Date of Birth'
                value={data.wifeDateOfBirth}
              />
              <PreviewField label='Age' value={data.wifeAge} />
              <PreviewField
                label='Place of Birth'
                value={formatPlace(data.wifePlaceOfBirth)}
              />
            ...
            <PreviewSection title="Wife's Family">
              <PreviewField
                label="Father's Name"
                value={formatName(data.wifeFatherName)}
              />
              <PreviewField
                label="Father's Citizenship"
                value={data.wifeFatherCitizenship}
              />
              <PreviewField
                label="Mother's Maiden Name"
                value={formatName(data.wifeMotherMaidenName)}
              />
              <PreviewField
                label="Mother's Citizenship"
                value={data.wifeMotherCitizenship}
              />
            </PreviewSection>
            ...
            <PreviewSection title='Marriage Details'>
              {data.placeOfMarriage && (
                <PreviewField
                  ...
                  value={`${data.placeOfMarriage.office}, ${formatPlace(
                    data.placeOfMarriage
                  )}`}
                />
              )}
              ...
              />
              <PreviewField
                label='Time of Marriage'
                value={data.timeOfMarriage}
              />
            </PreviewSection>
            ...
            {data.solemnizingOfficer && (
              <PreviewSection title='Solemnizing Officer'>
                <PreviewField
                  label='Name'
                  value={data.solemnizingOfficer.name}
                />
                <PreviewField
                  label='Position'
                  value={data.solemnizingOfficer.position}
                />
                <PreviewField
                  label='Religion'
                  value={data.solemnizingOfficer.religion}
                />
                <PreviewField
              ...
              <PreviewSection title='Consent Information'>
                {data.husbandConsentPerson && (
                  <div className='space-y-2'>
                    ...
                    <PreviewField
                      label='Name'
                      value={formatName(data.husbandConsentPerson.name)}
                    />
                    <PreviewField
                      label='Relationship'
                      value={data.husbandConsentPerson.relationship}
                    />
                    <PreviewField
                      label='Residence'
                      value={data.husbandConsentPerson.residence}
                    />
                  </div>
                )}
                {data.wifeConsentPerson && (
                  <div className='space-y-2 mt-4'>
                    ...
                    <PreviewField
                      label='Name'
                      value={formatName(data.wifeConsentPerson.name)}
                    />
                    <PreviewField
                      label='Relationship'
                      value={data.wifeConsentPerson.relationship}
                    />
                    <PreviewField
                      label='Residence'
                      value={data.wifeConsentPerson.residence}
                    />
                  </div>
                )}
              </PreviewSection>
