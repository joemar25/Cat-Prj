      ...
      <Page size='A4' style={styles.page}>
        ...
        <View style={{ border: '1px solid #000' }}>
              ...
              <View style={styles.leftGrid}>
                ...
                <View style={{ flexDirection: 'row', borderBottom: '1px solid #000' }}>
                  <View style={styles.sexGrid}>
                    ...
                    <Text style={styles.sexValue}>{data.childInfo?.sex || 'N/A'}</Text>
                  </View>
                  <View style={{ width: '85%' }}>
                ...
                <View style={styles.placeOfBirthContainer}>
                  ...
                  <View style={styles.placeOfBirthColumn}>
                    <Text style={styles.placeOfBirthLabel}>City/Municipality:</Text>
                    <Text style={styles.placeOfBirthValue}>
                ...
                <View style={styles.bottomGridContainer}>
                  ...
                  <View style={styles.bottomGridColumn}>
                    <Text style={styles.bottomGridLabel}>Multiple Birth Order:</Text>
                    <Text style={styles.bottomGridValue}>
              ...
              <View style={styles.leftGrid}>
                ...
                <View style={{ flexDirection: 'row', borderBottom: '1px solid #000' }}>
                  <View style={{ width: '50%', borderRight: '1px solid #000' }}>
                    <View style={[styles.fieldContainer, { flexDirection: 'column', padding: 1 }]}>
                ...
                <View style={{ flexDirection: 'row', borderBottom: '1px solid #000' }}>
                  <View style={{ width: '25%', borderRight: '1px solid #000' }}>
                    <View style={[styles.fieldContainer, { flexDirection: 'column', padding: 7.3 }]}>
                      <Text style={styles.label}>Total Children Born Alive:</Text>
                      <Text style={styles.value}>
                  ...
                  <View style={{ width: '25%' }}>
                    <View style={[styles.fieldContainer, { flexDirection: 'column', padding: 3 }]}>
                      <Text style={styles.label}>Age at time of this birth(completed years):</Text>
                      <Text style={styles.value}>
          ...
          <View>
            <View style={styles.gridContainer}>
              ...
              <View style={styles.leftGrid}>
                ...
                <View style={{ flexDirection: 'row', borderBottom: '1px solid #000' }}>
                  <View style={{ width: '25%', borderRight: '1px solid #000' }}>
                    <View style={[styles.fieldContainer, { flexDirection: 'column', padding: 7 }]}>
                      <Text style={styles.label}>Citizenship:</Text>
                      <Text style={styles.value}>
                  ...
                  <View style={{ width: '25%' }}>
                    <View style={[styles.fieldContainer, { flexDirection: 'column', padding: 2.5 }]}>
                      <Text style={styles.label}>Age at time of this birth(completed years):</Text>
                      <Text style={styles.value}>
          ...
          <View style={styles.sectionGrid}>
            ...
            <Text style={styles.value}>
              {data.attendant?.type || 'N/A'} - {data.attendant?.certification?.name || 'N/A'}
            </Text>
          </View>

          {/* Certification of Attendant at Birth */}
          <View style={[styles.sectionGrid, { padding: 3 }]}>
            <Text style={[styles.label, { fontSize: 7 }]}>CERTIFICATION OF ATTENDANT AT BIRTH</Text>
            <Text style={[styles.value, { fontSize: 7 }]}>
              ...
              </Text>{' '} on the date of birth specified above.
            </Text>
            ...
            <View style={{ flexDirection: 'row', marginTop: 3 }}>
              <View style={{ width: '50%' }}>
                <Text style={[styles.label, { fontSize: 7 }]}>Name in Print:</Text>
                <Text style={[styles.value, { fontSize: 7 }]}>
                  {data.attendant?.certification?.name || 'N/A'}
                </Text>
              </View>
              <View style={{ width: '50%' }}>
                <Text style={[styles.label, { fontSize: 7 }]}>Title or Position:</Text>
                <Text style={[styles.value, { fontSize: 7 }]}>
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={[styles.sectionGrid, { width: '50%', borderRight: '1px solid #000', padding: 3 }]}>
              <Text style={[styles.label, { fontSize: 7 }]}>CERTIFICATION INFORMAT</Text>
              <Text style={[styles.value, { fontSize: 7 }]}>
              ...
              <View style={{ flexDirection: 'row', marginTop: 3 }}>
                <View style={{ width: '50%' }}>
                  <Text style={[styles.label, { fontSize: 7 }]}>Relationship to the Child:</Text>
                  <Text style={[styles.value, { fontSize: 7 }]}>
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={[styles.sectionGrid, styles.registeredAtGrid]}>
              <Text style={[styles.label, { fontSize: 7 }]}>REGISTERED AT THE OFFICE OF THE CIVIL REGISTRAR</Text>
              <View style={{ flexDirection: 'row', marginTop: 3 }}>
                <View style={{ width: '50%' }}>
                  <Text style={[styles.label, { fontSize: 7 }]}>Signature:</Text>
                  <Text style={[styles.value, { fontSize: 7 }]}>
              ...
              <View style={{ flexDirection: 'row', marginTop: 3 }}>
                ...
                <View style={{ width: '50%' }}>
                  <Text style={[styles.label, { fontSize: 7 }]}>Date:</Text>
                  <Text style={[styles.value, { fontSize: 7 }]}>
                    {data.registeredByOffice?.date || 'N/A'}
                  </Text>
                </View>
              </View>
            </View>
