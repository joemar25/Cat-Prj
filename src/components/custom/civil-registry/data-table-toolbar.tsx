...
import { AddCivilRegistryFormDialog } from './actions/add-civil-registry-form-dialog';

interface DataTableToolbarProps<TData extends CivilRegistryForm> {
  table: Table<TData>;
}
...
export function DataTableToolbar<TData extends CivilRegistryForm>({
  table,
